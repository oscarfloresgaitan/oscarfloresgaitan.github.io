...
const translations = {
  en: {
    ...
    'research.1.desc': "A follow-up analysis of the confirmed planetary system around Barnard's Star using frequency-domain techniques, Gaussian Process (GP) modeling, orbital configuration exploration, and dynamical stability analysis.",
    ...
    'teaching.tutoring.btn': 'Learn More',
  ...
  es: {
    ...
    'research.1.desc': "Un análisis de seguimiento del sistema planetario confirmado alrededor de la Estrella de Barnard utilizando técnicas en el dominio de la frecuencia, modelado de Procesos Gaussianos (GP), exploración de configuraciones orbitales y análisis de estabilidad dinámica.",
    'research.2.title': 'orbcloud',
